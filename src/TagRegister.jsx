...
import { AdminRegister,getAllAdminReisters} from './Services/Api';
    ...
    onSubmit: async (values, { setFieldError }) => {
      try {
        ...
        if (response.data === "adminotp1") {
          navigate("/adminotp", { state: { data: values } });
        } else {
        ...
        <form onSubmit={formik.handleSubmit}>
         ...
         <div id="register" className="col-md-6 mb-4">
           ...
           <div id="register" className="col-md-6 mb-4">
              ...
              />
              {formik.touched.ename && formik.errors.ename && (
                <div className="invalid-feedback">{formik.errors.ename}</div>
              )}
            </div>
           <div id="register" className="col-md-6 mb-4">
           ...
           <div id="register" className="col-md-6 mb-4">
              ...
              <div className="input-group">
                ...
                <button
                  ...
                  onClick={setResponse}
                >
                  {formik.values.showPassword ?<FaEye style={{height:"20px",width:'20px'}}/> : <FaEyeSlash style={{height:"20px",width:'20px'}}/>}
                </button>
              </div>
              {formik.touched.password && formik.errors.password && (
                <div style={{display:"flex"}}className="invalid-feedback">{formik.errors.password}</div>
              )}
            </div>
           <div id="register" className="col-md-6 mb-4">
              ...
              <div className="input-group">
                ...
                >
                  {formik.values.showPassword1 ? <FaEye style={{height:"20px",width:'20px'}}/> : <FaEyeSlash style={{height:"20px",width:'20px'}}/>}
                </button>
              </div>
              {formik.touched.cnpassword && formik.errors.cnpassword && (
                <div style={{display:"flex"}} className="invalid-feedback">{formik.errors.cnpassword}</div>
              )}
            </div>
          </div>
          <br />
